...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='/nfshomes/zizhlian/scratch/mmlab/mmtracking/work_dirs'
        '/centertrack_dla34_dcnv2_140e_crowdhuman_private'
        '/epoch_140.pth'),  # here for mmlab checkpoints
    detector=dict(
        type='CTDetector',
        backbone=dict(
            type='DLA',
